...
func enter() -> void:
	...
	enemy.play_animation("Monstr_angry", 0.2, 1.0)
...
func update(delta: float) -> void:
	...
	if not enemy.anim_player.is_playing() or enemy.anim_player.current_animation != "Monstr_angry":
		enemy.play_animation("Monstr_angry", 0.1, 1.0)
