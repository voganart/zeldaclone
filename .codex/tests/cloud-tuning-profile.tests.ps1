...
foreach ($token in @(
    ...
    'horizontal_prewarm_chunks',
    'vertical_prewarm_chunks',
    'weather_scale',
    'weather_threshold',
...
foreach ($token in @(
    ...
    'horizontal_chunk_radius: int = 2',
    'vertical_chunk_radius: int = 1',
    'horizontal_prewarm_chunks: int = 1',
    'vertical_prewarm_chunks: int = 1',
