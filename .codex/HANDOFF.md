...
1. Выполнить GUI smoke-test нового Roll low-passage flow из `e074f98`.
   ...
   Стоячая форма возвращается только после clearance-проверки;
   ...
   полный выход и временно удлинённый obstacle.
